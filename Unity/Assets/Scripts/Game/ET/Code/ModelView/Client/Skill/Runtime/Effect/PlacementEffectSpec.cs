...
namespace ET
{
    ...
    public class PlacementEffectSpec : GameplayEffectSpec
    {
        ...
        private void SpawnPlacement(Vector3 position)
        {
            ...
            {
                _placementObject = UnityEngine.Object.Instantiate(nodeData.placementPrefab, position, UnityEngine.Quaternion.identity);
            }
            else
            {
        ...
        public override void Cancel()
        {
            ...
            {
                UnityEngine.Object.Destroy(_placementObject);

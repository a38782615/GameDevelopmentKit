namespace ET
{
    ...
    public class CooldownEffectSpec : GameplayEffectSpec
    {
        ...
        public override void Execute()
        {
            ...
            UnityEngine.Debug.Log($"[CooldownEffect] 执行CD效果, SkillId: {SkillId}, CooldownType: {nodeData.cooldownType}, GrantedTags: [{string.Join(", ", Tags.GrantedTags.Tags ?? new GameplayTag[0])}]");

...
namespace ET.Client.Editor
{
    public abstract class SkillNodeBase : GraphViewNode
    {
        ...
        public static readonly Dictionary<int, string> s_OutputPortNames = new Dictionary<int, string>
        {
            ...
            { SkillPortId.Ability.EventOnHit, "受击时" },
            { SkillPortId.Ability.EventOnDealDamage, "造成伤害时" },
            { SkillPortId.Ability.EventOnTakeDamage, "受到伤害时" },
            { SkillPortId.Ability.EventOnDeath, "死亡时" },
            { SkillPortId.Ability.EventOnKill, "击杀时" },

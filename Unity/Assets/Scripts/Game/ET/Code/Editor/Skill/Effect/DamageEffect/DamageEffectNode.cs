...
namespace ET.Client.Editor
{
    public class DamageEffectNode : EffectNode<DamageEffectNodeData>
    {
        ...
        protected override void SyncEffectContentFromData()
        {
            ...
            {
                damageTypeField.SetValueWithoutNotify(TypedData.damageType);
            }
        ...
        {
            if (damageValueLabel == null || TypedData == null)
            {
                return;
            }
            ...
            if (TypedData.enableHitKnockback)
            {
                displayValue = $"{displayValue} | 击退 {TypedData.knockbackDistance:F1}";
            }

...
{
    /// <summary>
    /// 基于FragmentList实现的XDictionary
    /// </summary>
    /// <typeparam name="K"></typeparam>
    /// <typeparam name="V"></typeparam>
    public class XDictionaryFragmentList<K, V> where V : class
    {
        /// <summary>
        /// 为Dictionary定制的内存分配器
        /// </summary>
        ...
        /// 字典
        /// </summary>
        private Dictionary<K, KeyValue<K, V>> mMap
            = new Dictionary<K, KeyValue<K, V>>();
        /// <summary>
        /// 链表
        /// </summary>
        private XFragmentList<KeyValue<K, V>> mList = new XFragmentList<KeyValue<K, V>>();
        /// <summary>
        /// 获取列表来遍历
        /// </summary>
        /// <returns></returns>
        public XFragmentList<KeyValue<K, V>> GetList()
        {
            return mList;
        }//GetList

...
namespace ET
{
    internal sealed class DelauEdgeList : IDisposable
    {
        ...
        public DelauEdgeList(float xmin, float deltax, int sqrt_nsites)
        {
            _xmin = xmin;
            _deltax = deltax;
        ...
        public void Remove(Halfedge halfEdge)
        {
            ...
            halfEdge.edge = DelauEdge.DELETED;
        ...
        private Halfedge GetHash(int b)
        {
            ...
            halfEdge = _hash[b];
            if (halfEdge != null && halfEdge.edge == DelauEdge.DELETED)
            {
